			...
			<section class="news-section company-section">
				...
				<div class="modal_request" >
					<div class="request-top">
						<h3 class="request-tit">이미지 업로드</h3>
					</div>

					
					<form name="writeForm" method="post" action="<%=request.getContextPath() %>/upload/uploadok.do" onsubmit="return doWrite()"  enctype="multipart/form-data" >
									...
									<li><label for="email" class="th_tit">태그</label>
										<div class="td_txt">
											<input type="text" id="tags" name="tags"
												style="ime-mode: disabled;width:60%;">

...
<script>
	function gomy(){
		location.href = "${pageContext.request.contextPath}/memberPage.do";
	}
</script>
			...
			<section class="news-section company-section">
				...
				<div class="modal_request">
					<div class="request-top">
						<h3 class="request-tit">내 정보 수정</h3>
					</div>



					<form name="writeForm" method="post"
						action="<%=request.getContextPath()%>/memberModifyProcess.do"
						...
						<fieldset>
							...
							<div class="request-cont">
								...
								<ul class="request-input">
									...
									<li><label for="PASSWORD" class="th_tit">비밀번호</label>
										<div class="td_txt">
											...
											<span style="font-weight:bold;color:red;">(비밀번호 수정시에만 입력하세요)</span>
										</div>
									</li>
									...
									<li><label for="EMAIL" class="th_tit">이메일</label>
										<div class="td_txt">
											<input type="text" id="email_id" name="email_id"
												style="ime-mode: disabled; width: 30%;" value="${ memberVO.email_id}" > @ <input
												type="text" id="email_domain" name="email_domain"
												style="ime-mode: disabled; width: 30%;" value="${ memberVO.email_domain}"> <select
												id="selmail">
								...
								<ul
									style="border-bottom: solid 2px #3BB54A; margin: 20px 0px 20px 0px;">
									<li><label class="hr_tag">※ 선택 정보</label></li>
								</ul>
									...
									<li><label for="TEL" class="th_tit">전화번호</label>
										<div class="td_txt">
											<select name="tel1" id="tel1">
												...
												style="ime-mode: disabled; width: 30%;" class="onlyNumber"
												maxlength="4" value="${ memberVO.tel2}" > - <input type="text" id="tel3"
												name="tel3" style="ime-mode: disabled; width: 30%;"
												class="onlyNumber" maxlength="4" value="${ memberVO.tel3}" >

										</div>
									</li>
									<script type="text/javascript">
										$(document).ready(function(){
											var hp1 = '${ memberVO.tel1}';
											$("#tel1").val(hp1);
									...
									<li><label for="POST" class="th_tit">주소</label>
										<div class="td_txt">
											<input type="text" id="post" name="post"
												style="ime-mode: disabled; width: 30%;" readonly=readonly value="${ memberVO.post}" >
											<input type="button" class="membtn" value="우편번호 찾기"
												onclick="DaumPostcode()" /> <span
										...
										<div class="td_txt" style="margin-top: 10px;">
											<input type="text" id="basic_addr" name="basic_addr"
												style="ime-mode: disabled" placeholder="기본주소"
												readonly=readonly value="${ memberVO.basic_addr}" >
										</div>

										<div class="td_txt" style="margin-top: 10px;">
											<input type="text" id="detail_addr" name="detail_addr"
												style="ime-mode: disabled" placeholder="상세주소" value="${ memberVO.detail_addr}" >
										</div></li>
								...
								<div class="request_btn">
									<div class="btn-wrap">
										<input type="submit" class="btn-style01" value="정보수정" style="cursor: pointer;" />
										<input type="button" class="btn-style01" value="취소" style="cursor: pointer;" onclick="gomy();" />
									</div>
								</div>
							</div>
						</fieldset>
